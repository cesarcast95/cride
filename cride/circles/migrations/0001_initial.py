    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='circle name')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited, this would be the limited on the numbers of members.')),
            ],
            options={
